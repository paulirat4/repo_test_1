...
with DAG(
    ...
    trigger_glue_job_movies_reviews = AwsGlueJobOperator(
        ...
        #dag=dag2,
        #dag=dag4,
        script_args= {'--bucket_for_processed_data_path': 's3://processed-data-bucket-20230130001153685200000006/movie_reviews',
    ...
    trigger_glue_job_log_reviews = AwsGlueJobOperator(
        ...
        script_location="s3://scripts-bucket-bootcamp-20230130001153688100000008/glue_log_reviews.py",
        #dag=dag2,
        #dag=dag4,
        script_args= {'--log_review_xml_path':   's3://s3-data-bootcamp-20230130001153688600000009/review_log.xml',
        '--bucket_for_processed_data_path':   's3://processed-data-bucket-20230130001153685200000006/log_reviews',
        '--extra-jars':   's3://resources-bucket-20230130001153683500000005/spark-xml_2.11-0.4.0.jar',
        }
        )
    ...
    postgres_to_s3 = postgresql_to_s3_bucket(
        ...
        s3_bucket="processed-data-bucket-20230130001153685200000006",
        # s3_key="test_1.csv",
