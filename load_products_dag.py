...
s3_to_postgres_operator = S3ToPostgresTransfer(
    ...
    s3_bucket="s3-data-bootcamp-20220206212504745900000004",
    # s3_key="test_1.csv",
...
from_s3_to_s3= fromS3toS3(
    ...
    table="products",
    # s3_bucket="bucket-test-45",
    s3_bucket="s3-data-bootcamp-20220206043241941100000001",
    # s3_key="test_1.csv",
...
postgres_to_s3 = postgresql_to_s3_bucket(
    ...
    table="products",
    # s3_bucket="bucket-test-45",
    s3_bucket="processed-data-bucket-20220206212504744100000002",
    # s3_key="test_1.csv",
